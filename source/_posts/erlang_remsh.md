...
### 启动a shell
```
chenduo@chenduo-desktop:~$ erl -name a@127.0.0.1 -setcookie abc
...
```
chenduo@chenduo-desktop:~$ erl -name b@127.0.0.1 -setcookie abc
Erlang R15B03 (erts-5.9.3.1) [source] [64-bit] [smp:4:4] [async-threads:0] [hipe] [kernel-poll:false]
...
```
chenduo@chenduo-desktop:~$ erl -name b@127.0.0.1 -setcookie abc -remsh a@127.0.0.1
Erlang R15B03 (erts-5.9.3.1) [source] [64-bit] [smp:4:4] [async-threads:0] [hipe] [kernel-poll:false]
